...
import { Trash2, Plus, Upload, Download, Users } from 'lucide-react';
...
interface InvoiceItem {
  ...
  date: string;
  reference: string;
  amount: number | string; // Allow string for input handling, parse float for calc
}
...
export default function InvoiceApp() {
  ...
  // Get current selected customer object
  const currentCustomer = customers.find(c => c.id === selectedCustomerId) || customers[0];

  // Logic Condition: Is this the Meekhun customer?
  ...
  const handleDownloadPDF = () => {
    // Cast window to any to access html2pdf
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 md:p-8 font-sans">
      <style>{`
        ...
        .text-label { color: #9CA3AF; } /* Light gray for headers */
        .bg-footer { background-color: #0F172A; } /* Dark Navy */
      `}</style>

      {/* Editor Controls */}
      <div className="max-w-4xl mx-auto mb-6 bg-white rounded-lg shadow p-6">
          ...
          <div className="flex flex-col justify-center gap-3 col-span-2 md:col-span-2">
            <div className="flex gap-4">
              ...
              <button 
                ...
                className={`flex-1 flex items-center justify-center gap-2 text-white px-4 py-3 rounded-lg font-medium transition-colors ${
      ...
      <div className="flex justify-center overflow-auto pb-10">
        <div id="invoice-preview" className="bg-white shadow-2xl w-[210mm] h-[297mm] relative text-gray-800 flex flex-col justify-between">
            ...
            <div className="flex justify-between items-start mb-12">
              ...
              >
                ...
                {logoSrc ? (
                  ...
                  <div className="border border-dashed border-gray-300 w-full h-full flex items-center justify-center text-gray-400 text-xs bg-gray-50 group-hover:bg-gray-100">
                    Click to add Logo
                  </div>
                )}
              </div>
          ...
          <div className="bg-footer text-white p-12 mt-auto print:bg-[#0F172A] print:text-white">
            <h3 className="text-gray-400 text-xs uppercase mb-4">Bank Details</h3>
            <div className="text-sm font-medium leading-relaxed">
              <p className="mb-1">Chaitawat Poovaviranon</p>
