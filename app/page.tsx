...
export default function InvoiceGenerator() {
  ...
  // AUTO LOGO LOGIC
  // Automatically switch logo based on customer selection
  useEffect(() => {
    if (selectedCustomerId === 1) {
      // Points to /public/pad-logo.png
      setLogoSrc('/pad-logo.png');
    } else {
      // Reset for Meekhun or others
      setLogoSrc(null);
    }
  }, [selectedCustomerId]);
    ...
    <div className="min-h-screen bg-gray-100 p-4 md:p-8 font-sans">
      ...
      <div className="max-w-4xl mx-auto mb-6 bg-white rounded-lg shadow p-6 relative">
        <div className="flex justify-between items-start mb-4">
          ...
          <span className="text-[10px] text-gray-400 font-mono mt-2 tracking-wider">v.2602161520</span>
        </div>
            ...
            <div className="flex justify-between items-start mb-12">
              ...
              >
                ...
                {logoSrc ? (
                  ...
                  <div className="border border-dashed border-gray-300 w-full h-full flex items-center justify-center text-gray-400 text-xs bg-gray-50 group-hover:bg-gray-100 text-center px-4">
                    Click to add Logo
                  </div>
                )}
              </div>
